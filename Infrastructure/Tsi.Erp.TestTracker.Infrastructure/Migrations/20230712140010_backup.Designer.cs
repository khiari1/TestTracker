...
namespace Tsi.Erp.TestTracker.Infrastructure.Migrations
{
    ...
    [Migration("20230712140010_backup")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Tsi.Erp.TestTracker.Domain.Models.Group", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Tsi.Erp.TestTracker.Domain.Models.Permission", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Tsi.Erp.TestTracker.Domain.Models.Ticket", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Tsi.Erp.TestTracker.Domain.Models.TicketState", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Tsi.Erp.TestTracker.Domain.Models.TicketType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Tsi.Erp.TestTracker.Domain.Models.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GroupUser", b =>
                {
                    b.HasOne("Tsi.Erp.TestTracker.Domain.Models.Group", null)
                        .WithMany()
                        .HasForeignKey("GroupsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Tsi.Erp.TestTracker.Domain.Models.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Tsi.Erp.TestTracker.Domain.Models.Comment", b =>
                {
                    b.HasOne("Tsi.Erp.TestTracker.Domain.Models.User", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Tsi.Erp.TestTracker.Domain.Models.Monitoring", b =>
                {
                    ...
                    b.HasOne("Tsi.Erp.TestTracker.Domain.Models.User", "Tester")
                        .WithMany()
            ...
            modelBuilder.Entity("Tsi.Erp.TestTracker.Domain.Models.Permission", b =>
                {
                    b.HasOne("Tsi.Erp.TestTracker.Domain.Models.Group", "Group")
            ...
            modelBuilder.Entity("Tsi.Erp.TestTracker.Domain.Models.Ticket", b =>
                {
                    b.HasOne("Tsi.Erp.TestTracker.Domain.Models.User", "AssignedTo")
                        .WithMany()
                    ...
                    b.HasOne("Tsi.Erp.TestTracker.Domain.Models.TicketState", "State")
                        .WithMany()
                        .HasForeignKey("StateId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Tsi.Erp.TestTracker.Domain.Models.TicketType", "TicketType")
                        .WithMany()
